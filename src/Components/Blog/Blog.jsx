...
const Blog = () => {
    return (
        <div className="grid grid-cols-1 justify-items-center mt-16">
            <div>
                <h1 className="text-2xl font-serif font-semibold underline">Click and see blog questions!!</h1>
            </div>
            <div className="mt-7">
                <label htmlFor="my-modal-5" className="btn lowercase">1. What is an access token and refresh token? How do they work and where should we store them on the client-side?
                </label>
            ...
            <div className="mt-7">
                <label htmlFor="my-modal-6" className="btn lowercase">2. Compare SQL and NoSQL databases?
                </label>
            ...
            <div className="mt-7">
                <label htmlFor="my-modal-7" className="btn lowercase">3. What is express js? What is Nest JS?
                </label>
            ...
            <div className="mt-7">
                <label htmlFor="my-modal-8" className="btn lowercase">4. What is MongoDB aggregate and how does it work?
                </label>
